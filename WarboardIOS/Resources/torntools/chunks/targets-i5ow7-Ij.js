...
import { $ as mount, A as prop, At as user_derived, C as ttStorage, Ct as first_child, Dt as set, Ht as next, K as component, M as spread_props, Mt as setup_stores, N as init, Nt as store_get, Ot as state, P as bind_this, Pt as writable, Q as if_block, R as attribute_effect, Rt as pop, St as child, T as cn, Tt as proxy, Ut as reset, V as set_class, W as action, Wt as noop, Y as each, a as initializeDatabase, at as from_svg, bt as user_pre_effect, c as storageListeners, ct as delegate, et as set_text, it as from_html, j as rest_props, k as onMount, lt as delegated, mt as get, n as setMode, nt as append, ot as props_id, q as snippet, rt as comment, st as text$1, t as Mode_watcher, vt as template_effect, wt as sibling, z as set_attribute, zt as push } from "./dist-DghMY0ja.js";
import { $ as DialogRootState, C as formatTime, F as Text_selection_layer, Ht as Router, I as Focus_scope, J as Portal, L as Escape_layer, M as Dialog_overlay, Mt as afterSleep, N as Scroll_lock, Q as DialogContentState, R as Dismissible_layer, T as Separator, Ut as link, Vt as boxWith, Wt as replace, X as AlertDialogCancelState, Y as Dialog_title, a as Tooltip_provider, c as Sonner_1, et as createId, f as getIconContext, j as Dialog_description, m as buttonVariants, n as Input, p as Button, r as active, t as TrashIcon, tt as noop$1, u as toast, x as formatDate, zt as mergeProps } from "./TrashIcon-CnKkSyHV.js";
import { n as Switch, r as Checkbox, t as PlusIcon } from "./PlusIcon-Bblyouwl.js";
...
//#endregion
//#region extension/entrypoints/targets/components/attackhistory/AttackHistoryRedirect.svelte
...
//#endregion
//#region extension/entrypoints/targets/stores/database-store.svelte.ts
...
async function loadDatabaseStores() {
	const [settings, attackHistory, stakeouts] = await ttStorage.get([
		"settings",
		"attackHistory",
		"stakeouts"
	]);
...
//#endregion
//#region extension/svelte/components/ui/alert-dialog/alert-dialog.svelte
...
//#endregion
//#region extension/svelte/components/ui/alert-dialog/alert-dialog-cancel.svelte
...
//#endregion
//#region extension/svelte/components/ui/alert-dialog/alert-dialog-overlay.svelte
...
//#endregion
//#region extension/svelte/components/ui/alert-dialog/alert-dialog-portal.svelte
...
//#endregion
//#region extension/svelte/components/ui/alert-dialog/alert-dialog-content.svelte
...
//#endregion
//#region extension/svelte/components/ui/alert-dialog/alert-dialog-description.svelte
...
//#endregion
//#region extension/svelte/components/ui/alert-dialog/alert-dialog-footer.svelte
...
//#endregion
//#region extension/svelte/components/ui/alert-dialog/alert-dialog-header.svelte
...
from_html(`<div><!></div>`);
//#endregion
//#region extension/svelte/components/ui/alert-dialog/alert-dialog-title.svelte
...
//#endregion
//#region extension/entrypoints/targets/components/ResetAction.svelte
...
//#endregion
//#region extension/entrypoints/targets/components/attackhistory/columns.ts
var columns$1 = [
	createColumn$2("id", "ID"),
	createColumn$2("name", "Name"),
	createColumn$2("lastAttack", "Last Attack"),
	createColumn$2("win", "Wins"),
	createColumn$2("mug", "Mugs"),
	createColumn$2("leave", "Leaves"),
	createColumn$2("hospitalise", "Hosps"),
	createColumn$2("arrest", "Arrests"),
	createColumn$2("special", "Specials"),
	createColumn$2("stealth", "Stealths"),
	createColumn$2("assist", "Assists"),
	createColumn$2("defend", "Defends"),
	createColumn$2("lose", "Losses"),
	createColumn$2("stalemate", "Stalemates"),
	createColumn$2("escapes", "Escapes"),
	createColumn$2("defend_lost", "Defends Lost"),
	createColumn$2("respect", "Respect"),
	createColumn$2("fair_fight", "FF")
];
function createColumn$2(id, header) {
	return {
		accessorKey: id,
		header,
		enableSorting: true,
...
//#endregion
//#region extension/svelte/components/ui/data-table/data-table.svelte.ts
...
//#endregion
//#region extension/svelte/components/ui/data-table/render-helpers.ts
/**
...
//#endregion
//#region extension/svelte/components/ui/data-table/flex-render.svelte
...
//#endregion
//#region extension/entrypoints/targets/components/attackhistory/data-table.svelte
...
var root_16$1 = from_html(`<a class="hover:underline" target="_blank" rel="noreferrer"> </a>`);
...
var root$4 = from_html(`<div class="overflow-hidden rounded-sm border bg-card"><!></div>`);
...
delegate(["click"]);
//#endregion
//#region extension/entrypoints/targets/components/attackhistory/HistoryTable.svelte
...
//#endregion
//#region extension/entrypoints/targets/components/attackhistory/AttackHistory.svelte
var root$3 = from_html(`<div class="space-y-2"><div class="flex flex-wrap items-center justify-between gap-2"><div><h1 class="text-2xl font-bold">Attack History</h1> <p class="text-sm text-muted-foreground"> </p></div> <div class="flex items-center gap-2"><label class="flex items-center gap-2 text-sm"><!> <span>Show percentages</span></label> <!></div></div> <!></div>`);
...
//#endregion
//#region extension/entrypoints/targets/components/stakeouts/helpers.ts
function getStakeoutRows(source) {
	return (source?.order ?? []).map((id) => getStakeoutRow(id, source?.[id], false));
}
function getStakeoutRow(id, source, isNew) {
	if (source && typeof source === "object" && !Array.isArray(source)) {
		const stakeout = source;
		return {
			id,
...
function getStoredStakeouts(sourceRows, currentDate = 0) {
	...
	for (const row of sourceRows) nextStakeouts[row.id] = {
		info: row.info,
		alerts: row.alerts,
		label: row.label
	};
...
//#endregion
//#region extension/entrypoints/targets/components/stakeouts/columns.ts
var columns = [
	createColumn("id", "ID"),
...
//#endregion
//#region extension/entrypoints/targets/components/stakeouts/AlertCheckbox.svelte
...
//#endregion
//#region extension/entrypoints/targets/components/stakeouts/data-table.svelte
...
//#endregion
//#region extension/entrypoints/targets/components/stakeouts/StakeoutsTable.svelte
...
//#endregion
//#region extension/entrypoints/targets/components/stakeouts/Stakeouts.svelte
...
function Stakeouts($$anchor, $$props) {
	...
	const $stakeoutsStore = () => store_get(stakeoutsStore, "$stakeoutsStore", $$stores);
	const [$$stores, $$cleanup] = setup_stores();
	const amountOfRows = user_derived(() => $stakeoutsStore()?.order?.length ?? 0);
	...
	function addStakeout() {
		...
		if (rows.some((row) => row.id === String(get(stakeoutId)))) {
			toast.error("This user already has a stakeout.");
			return;
		}
		const nextStakeouts = getStoredStakeouts([...rows, getStakeoutRow(String(get(stakeoutId)), null, true)], $stakeoutsStore()?.date ?? 0);
...
//#endregion
//#region extension/entrypoints/targets/Targets.svelte
...
//# sourceMappingURL=targets-i5ow7-Ij.js.map