import { A as isSellable, C as getNextChainBonus, D as getStockIncrement, E as getStockBoughtPrice, M as changeAPIKey, N as checkAPIPermission, O as getStockReward, P as fetchData, T as getRewardValue, a as Card, g as ALL_ICONS, i as Card_content, k as isDividendStock, m as Spinner, n as Card_header, p as Badge, r as Card_description, t as Card_title, w as getRequiredStocks, x as LINKS } from "./card-CykqZuMp.js";
import { t as browser } from "./browser-DV2XfOQj.js";
import { $ as mount, A as prop, At as user_derived, B as set_style, C as ttStorage, Ct as first_child, Dt as set, G as element, H as clsx, Ht as next, I as bind_value, K as component, M as spread_props, Mt as setup_stores, N as init, Nt as store_get, Ot as state, P as bind_this, Pt as writable, Q as if_block, R as attribute_effect, Rt as pop, S as ttCache, St as child, T as cn, Tt as proxy, Ut as reset, V as set_class, Vt as snapshot, W as action, Wt as noop, X as index, Y as each, Z as key, _ as isToday, a as initializeDatabase, at as from_svg, bt as user_pre_effect, c as storageListeners, et as set_text, it as from_html, j as rest_props, k as onMount, mt as get, n as setMode, nt as append, o as loadDatabase, ot as props_id, p as TO_MILLIS, q as snippet, rt as comment, st as text, t as Mode_watcher, v as sleep, vt as template_effect, wt as sibling, x as isHTMLElement, yt as user_effect, z as set_attribute, zt as push } from "./dist-DghMY0ja.js";
import { C as formatTime, Gt as router, Ht as Router, It as watch, Lt as Context, Mt as afterSleep, P as useId, Rt as srOnlyStyles, S as formatNumber, T as Separator, Ut as link, Vt as boxWith, Wt as replace, _ as capitalizeText, a as Tooltip_provider, bt as boolToEmptyStrOrUndef, c as Sonner_1, ct as ARROW_LEFT, et as createId, f as getIconContext, g as applyPlural, h as tv, ht as HOME, i as Tooltip_trigger, jt as afterTick, kt as attachRef, l as Check, lt as ARROW_RIGHT, n as Input, o as Tooltip_content, p as Button, pt as ENTER, q as getFirstNonCommentChild, r as active, s as Tooltip, st as ARROW_DOWN, t as TrashIcon, tt as noop$1, ut as ARROW_UP, w as toSeconds, wt as createBitsAttrs, x as formatDate, xt as boolToStr, y as dropDecimals, zt as mergeProps } from "./TrashIcon-CnKkSyHV.js";
import { t as CaretDownIcon } from "./CaretDownIcon-Eug5mOA7.js";
...
//#endregion
//#region extension/svelte/components/ui/command/command.svelte
...
from_html(`<!> <!>`, 1);
//#endregion
//#region extension/svelte/components/ui/command/command-empty.svelte
...
//#endregion
//#region extension/svelte/components/ui/command/command-group.svelte
...
//#endregion
//#region extension/svelte/components/ui/input-group/input-group.svelte
...
//#endregion
//#region extension/svelte/components/ui/input-group/input-group-addon.svelte
...
//#endregion
//#region extension/svelte/components/ui/input-group/input-group-input.svelte
...
var root_7$8 = from_svg(`<path d="M226.83,221.17l-52.7-52.7a84.1,84.1,0,1,0-5.66,5.66l52.7,52.7a4,4,0,0,0,5.66-5.66ZM36,112a76,76,0,1,1,76,76A76.08,76.08,0,0,1,36,112Z"></path>`);
...
//#endregion
//#region extension/svelte/components/ui/command/command-input.svelte
...
//#endregion
//#region extension/svelte/components/ui/command/command-item.svelte
...
//#endregion
//#region extension/svelte/components/ui/command/command-list.svelte
...
//#endregion
//#region extension/svelte/components/ui/command/command-shortcut.svelte
...
//#endregion
//#region extension/entrypoints/popup/stores/database-store.svelte.ts
...
//#endregion
//#region extension/entrypoints/popup/components/calculator/CalculatorInput.svelte
...
//#endregion
//#region extension/entrypoints/popup/components/calculator/ItemList.svelte
...
//#endregion
//#region extension/entrypoints/popup/components/calculator/Calculator.svelte
...
//#endregion
//#region extension/entrypoints/popup/components/dashboard/Bars.svelte
var root_4$9 = from_html(`<a class="block space-y-1" target="_blank" rel="noreferrer"><div class="flex items-center justify-between text-xs"><span> </span> <span class="text-muted-foreground"> </span></div> <div class="h-1.5 overflow-hidden rounded-sm bg-muted"><div></div></div> <div class="flex justify-between gap-2 text-xs leading-none text-muted-foreground"><span> </span> <span class="truncate text-right"> </span></div></a>`);
var root_5$10 = from_html(`<div class="text-xs text-muted-foreground">No bar data available.</div>`);
...
//#endregion
//#region extension/entrypoints/popup/components/dashboard/Cooldowns.svelte
var root_2$9 = from_html(`<a class="rounded-lg bg-card border border-border/70 p-1 text-center text-xs hover:bg-muted" target="_blank" rel="noreferrer"><div> </div> <div class="text-muted-foreground"> </div></a>`);
...
//#endregion
//#region extension/entrypoints/popup/components/dashboard/ExtraInformation.svelte
var root_1$11 = from_html(`<a class="rounded-lg bg-card border border-border/70 p-1 text-center text-xs hover:bg-muted" target="_blank" rel="noreferrer"><div class="font-medium"> </div> <div class="text-muted-foreground"> </div></a>`);
var root$19 = from_html(`<div class="grid grid-cols-3 gap-1"></div> <div class="flex items-center justify-between text-xs text-muted-foreground"><div class="flex items-center gap-1"><span>Updated</span> <span class="font-medium text-foreground"> </span></div> <!></div>`, 1);
function ExtraInformation($$anchor, $$props) {
	...
	var node = sibling(div_4, 2);
	{
		...
		let $1 = user_derived(() => get(notificationsEnabled) ? "text-primary" : "text-destructive");
...
//#endregion
//#region extension/entrypoints/popup/components/dashboard/FactionStakeouts.svelte
...
function FactionStakeouts($$anchor, $$props) {
	...
	var consequent_2 = ($$anchor) => {
		...
		if_block(node_3, ($$render) => {
			if (get(factionStakeoutsOpen)) $$render(consequent_1);
		});
		reset(section);
		append($$anchor, section);
	};
	if_block(node, ($$render) => {
		if (get(factionStakeoutRows).length) $$render(consequent_2);
	});
	append($$anchor, fragment);
	pop();
	$$cleanup();
...
//#endregion
//#region extension/entrypoints/popup/components/dashboard/Overview.svelte
...
//#endregion
//#region extension/entrypoints/popup/components/dashboard/StakeoutRow.svelte
var root_1$8 = from_html(`<span class="truncate text-muted-foreground"> </span>`);
var root$17 = from_html(`<div class="rounded-lg border bg-card p-2 text-xs"><div class="flex items-start gap-2"><a class="-m-1 block min-w-0 flex-1 rounded-md p-1 hover:bg-muted/60" target="_blank" rel="noreferrer"><div class="flex items-center gap-1.5"><span></span> <span class="truncate font-medium"> </span> <!></div> <div class="mt-1 grid grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-2 text-[10px] text-muted-foreground"><span>Life</span> <div class="h-1.5 flex-1 overflow-hidden rounded-sm bg-muted"><div class="h-full bg-blue-500"></div></div> <span> </span></div> <div class="mt-1 flex items-center justify-between gap-2"><span> </span> <span class="shrink-0 text-muted-foreground"> </span></div></a> <!></div></div>`);
...
//#endregion
//#region extension/entrypoints/popup/components/dashboard/Stakeouts.svelte
...
function Stakeouts($$anchor, $$props) {
	...
	var consequent_2 = ($$anchor) => {
		...
		reset(section);
		template_effect(() => set_attribute(a, "href", get(targetsUrl)));
		append($$anchor, section);
	};
	if_block(node, ($$render) => {
...
//#endregion
//#region extension/entrypoints/popup/components/dashboard/Dashboard.svelte
...
//#endregion
//#region extension/entrypoints/popup/tabs.ts
var POPUP_TABS = [
	{
		key: "dashboard",
		label: "Dashboard",
...
//#endregion
//#region extension/entrypoints/popup/components/GlobalLayout.svelte
...
function GlobalLayout($$anchor, $$props) {
	...
	onMount(() => {
		set(popupWidth, Math.min(432, screen.availWidth * .8), true);
...
//#endregion
//#region extension/entrypoints/popup/components/initialize/Initialize.svelte
...
//#endregion
//#region extension/entrypoints/popup/components/market/ItemSearch.svelte
...
//#endregion
//#region extension/svelte/components/ui/alert/helper.ts
...
//#endregion
//#region extension/svelte/components/ui/alert/alert.svelte
...
from_html(`<div><!></div>`);
//#endregion
//#region extension/svelte/components/ui/alert/alert-description.svelte
...
//#endregion
//#region extension/svelte/components/ui/alert/alert-title.svelte
...
//#endregion
//#region extension/entrypoints/popup/components/market/MarketPrice.svelte
var root_4$3 = from_html(`<!> <!>`, 1);
var root$10 = from_html(`<section class="space-y-1"><h2 class="text-xs font-bold"> </h2> <!></section>`);
...
//#endregion
//#region extension/entrypoints/popup/components/market/SearchResult.svelte
...
//#endregion
//#region extension/entrypoints/popup/components/market/Market.svelte
...
//#endregion
//#region extension/entrypoints/popup/components/notifications/Notification.svelte
...
//#endregion
//#region extension/entrypoints/popup/components/notifications/Notifications.svelte
...
//#endregion
//#region extension/entrypoints/popup/components/PopupRedirect.svelte
...
//#endregion
//#region extension/entrypoints/popup/components/stocks/StockSearch.svelte
...
//#endregion
//#region extension/entrypoints/popup/components/stocks/RoiTable.svelte
...
//#endregion
//#region extension/entrypoints/popup/components/stocks/BenefitInformation.svelte
...
//#endregion
//#region extension/entrypoints/popup/components/stocks/StockSection.svelte
...
//#endregion
//#region extension/entrypoints/popup/components/stocks/StocksTable.svelte
...
//#endregion
//#region extension/entrypoints/popup/components/stocks/Stocks.svelte
...
//#endregion
//#region extension/entrypoints/popup/Popup.svelte
...
//# sourceMappingURL=popup-CSBaatGq.js.map